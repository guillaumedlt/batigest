...
function calcLigneHT(l: LigneDevis): number {
  ...
  const p = parseFloat(l.prixUnitaireHT) || 0;
  return q * p;
}
...
export default function NouveauDevisPage() {
  ...
  const [conditions, setConditions] = useState('Reglement a 30 jours a compter de la date de facture.');
  ...
  async function handleSave() {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        alert(err.error || 'Erreur lors de la creation du devis.');
        return;
      }
    ...
    <div className="space-y-4 max-w-5xl">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl lg:text-2xl font-bold text-gray-900">Nouveau devis</h1>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
                ...
                <div>
                  ...
                  {showContactDropdown && contactSearch && filteredContacts.length === 0 && (
                    <div className="absolute z-10 w-full mt-1 bg-white border border-gray-200 rounded-xl shadow-lg p-4 text-center">
                      <p className="text-sm text-gray-400">Aucun client trouve</p>
                      <Link href="/contacts/nouveau" className="text-sm text-blue-600 font-medium mt-1 inline-block">
          ...
          <div className="bg-white rounded-2xl p-4 lg:p-6 shadow-sm">
            ...
            <input
              ...
              placeholder="Ex: Renovation salle de bain, Installation electrique..."
              className="w-full h-12 px-4 rounded-xl border border-gray-200 bg-white text-base
                         focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
        ...
        {/* Colonne droite — Totaux + conditions */}
