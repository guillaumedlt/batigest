              ...
              <div className="flex gap-2 mt-2 justify-center">
                {(['mensuel', 'trimestriel'] as const).map((m) => (
                  <button key={m} onClick={() => setViewMode(m)}
                    className={`px-3 py-1 rounded-full text-xs font-medium ${viewMode === m ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-600'}`}>
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
                ...
                <div className={`rounded-2xl p-5 shadow-sm ${data.solde > 0 ? 'bg-red-50' : data.solde < 0 ? 'bg-green-50' : 'bg-gray-50'}`}>
                  <div className="flex items-center gap-2 mb-2">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm print:shadow-none print:border print:border-gray-300">
              ...
              {/* ===== ACTIONS DECLARATION ===== */}
              <div className="bg-white rounded-2xl p-5 shadow-sm print:hidden">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm print:hidden">
