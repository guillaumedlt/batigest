...
function FormField({ name, label, placeholder, type = 'text', required = false, defaultValue = '' }: {
  name: string; label: string; placeholder: string; type?: string; required?: boolean; defaultValue?: string;
}) {
  return (
    <div>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold text-gray-900">Modifier le contact</h1>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-4 lg:p-6 space-y-5">
              ...
              {TYPES.map((type) => (
                ...
                >
                  <input type="radio" name="type" value={type.value}
                    defaultChecked={type.value === contact.type} className="w-4 h-4 text-blue-600" />
          ...
          <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
              <FormField name="nom" label="Nom *" placeholder="Dupont" required defaultValue={contact.nom} />
              <FormField name="prenom" label="Prenom" placeholder="Jean" defaultValue={contact.prenom || ''} />
              <FormField name="entreprise" label="Entreprise" placeholder="SARL Dupont Plomberie" defaultValue={contact.entreprise || ''} />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
              <FormField name="telephone" label="Telephone *" placeholder="06 12 34 56 78" type="tel" required defaultValue={contact.telephone} />
              <FormField name="email" label="Email" placeholder="jean@email.fr" type="email" defaultValue={contact.email || ''} />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <FormField name="adresse" label="Rue" placeholder="12 rue de la Paix" defaultValue={contact.adresse || ''} />
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
                <FormField name="codePostal" label="Code postal" placeholder="75001" defaultValue={contact.codePostal || ''} />
                <div className="col-span-1 lg:col-span-2">
                  <FormField name="ville" label="Ville" placeholder="Paris" defaultValue={contact.ville || ''} />
                </div>
              </div>
            </div>
          </div>
